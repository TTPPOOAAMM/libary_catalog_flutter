...
class ApiAuthorRepository implements AuthorRepository {
  ...
  @override
  Future<void> hardDelete(int id) => guard(() => _dio.delete('/authors/$id', queryParameters: {'hard': true}));
...
class ApiGenreRepository implements GenreRepository {
  ...
  @override
  Future<void> hardDelete(int id) => guard(() => _dio.delete('/genres/$id', queryParameters: {'hard': true}));
...
class ApiPublisherRepository implements PublisherRepository {
  ...
  @override
  Future<void> softDelete(int id) => guard(() => _dio.delete('/publishers/$id'));

  @override
  Future<void> hardDelete(int id) => guard(() => _dio.delete('/publishers/$id', queryParameters: {'hard': true}));

  @override
  Future<void> restore(int id) => guard(() => _dio.post('/publishers/$id/restore'));
...
class ApiReaderRepository implements ReaderRepository {
  ...
  Future<bool> isEmailUnique(String email, {int? excludeId}) async {
    try {
      ...
      return !res.items.any((r) => r.id != excludeId && r.email.toLowerCase() == email.trim().toLowerCase());
    } catch (_) {
      return true;
    }
  }
  ...
  @override
  Future<void> hardDelete(int id) => guard(() => _dio.delete('/readers/$id', queryParameters: {'hard': true}));

  @override
  Future<void> restore(int id) => guard(() => _dio.post('/readers/$id/restore'));
